...
public class RestExceptionHandler{
    ...
    public ResponseEntity<Object> handleTournamentExistsException(TournamentExistsException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("error", ex.getMessage());
        return new ResponseEntity<>(body, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleMatchCreationException(MatchCreationException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("error", ex.getMessage());
        return new ResponseEntity<>(body, HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<Object> handleNoPlayersRegisteredException(MatchCreationException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("error", ex.getMessage());
        return new ResponseEntity<>(body, HttpStatus.INTERNAL_SERVER_ERROR);
    }
